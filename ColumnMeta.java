...
public enum ColumnMeta
{
	...
	/** Gen in service */ 								GenOOS(ListMetaType.Gen), 
	...
	/** Load in service */ 								LoadOOS(ListMetaType.Load), 
	...
	/** Shunt Cap in service */ 						ShcapOOS(ListMetaType.ShuntCap), 
	...
	/** Shunt Reac in service */ 						ShreacOOS(ListMetaType.ShuntReac), 
	...
	/** SVC in service */ 								SvcOOS(ListMetaType.SVC), 
	...
	/** Line in service */ 								LineOOS(ListMetaType.Line), 
	...
	/** Series Cap in service */ 						SercapOOS(ListMetaType.SeriesCap), 
	...
	/** Series Reac in service */ 						SerreacOOS(ListMetaType.SeriesReac), 
	...
	/** Phase Shifter in service */ 					PhashOOS(ListMetaType.PhaseShifter), 
	...
	/** Phase Shifter from-side off-nom turns ratio  */ PhashTAPTO(ListMetaType.PhaseShifter),
	...
	/** Transformer in service */ 						TfmrOOS(ListMetaType.Transformer), 
	...
	/** Transformer Tap Side */							TfmrREGSIDE(ListMetaType.Transformer),
	...
	/** Switch in service */ 							SwOOS(ListMetaType.Switch), 
	...
	/** Two-Term DC Line in service */ 					T2dcOOS(ListMetaType.TwoTermDCLine), 
