...
public class LineSubList extends LineList
{
	...
	@Override
	public void setRTFromS(int ndx, Complex s) throws PsseModelException {_lines.setRTFromS(ndx, s);}
	@Override
	public void setRTToS(int ndx, Complex s) throws PsseModelException {_lines.setRTToS(ndx, s);}
	@Override
